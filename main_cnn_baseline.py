...
from model_spnet import CNN, clip_grad_value_
...
parser.add_argument('--name', type=str, default='main_cnn_baseline', help='')
...
if opt.checkpoints == 0:
    model = CNN(upscale_factor=opt.upscale_factor)
else:
