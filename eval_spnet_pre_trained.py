...
# parser.add_argument('--dataset', type=str, default='/home/yukai/data2/yukai/data/SR/VOC_train2/', help='')
# parser.add_argument('--dataset', type=str, default='/mnt/lustre/ganyukang/Data_t1/shiyukai/code/SR/convlstm/dataset/', help='')
...
model = torch.load('./checkpoints/main_spnetmodel_pre_trained.pth')
